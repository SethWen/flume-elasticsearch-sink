...
public class TimeBasedIndexNameBuilder implements IndexNameBuilder {
    ...
    public void configure(Context context) {
        ...
        indexPrefix = context.getString(Constants.INDEX);

        System.out.printf("configure: origin=%s, indexPrefix=%s, fastDateFormat%s\n", context.getString(Constants.INDEX), indexPrefix, fastDateFormat);
    }
